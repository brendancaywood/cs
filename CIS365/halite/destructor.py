...
while True:
    ...
    if game.turn_number % 6 == 0 and me.halite_amount >= constants.SHIP_COST and not game_map[me.shipyard].is_occupied and game.turn_number < SHIP_TURN_MAX and SHIP_NUM_MAX > numShips:
